...
Namespace CompuMaster.Test.Data
    ...
    <TestFixture(Category:="XLS Reader")> Public Class XlsReader
        ...
        <Test()> Public Sub ReadFormatExcel97()
            Dim TestFile As String = System.IO.Path.Combine(System.Environment.CurrentDirectory, "testfiles\test_for_lastcell_e70aka97-2003.xls")
            CompuMaster.Data.XlsReader.ReadDataTableFromXlsFile(TestFile, "test")
        End Sub

        <Test()> Public Sub ReadFormatExcel2007xlsx()
            Dim TestFile As String = System.IO.Path.Combine(System.Environment.CurrentDirectory, "testfiles\test_for_lastcell_e12aka2007.xlsx")
            CompuMaster.Data.XlsReader.ReadDataTableFromXlsFile(TestFile, "test")
        End Sub

        <Test()> Public Sub ReadFormatExcel2007xlsb()
            Dim TestFile As String = System.IO.Path.Combine(System.Environment.CurrentDirectory, "testfiles\test_for_lastcell_e12aka2007.xlsb")
            CompuMaster.Data.XlsReader.ReadDataTableFromXlsFile(TestFile, "test")
        End Sub

        <Test()> Public Sub ReadFormatExcel2007xlsm()
            Dim TestFile As String = System.IO.Path.Combine(System.Environment.CurrentDirectory, "testfiles\test_for_lastcell_e12aka2007.xlsm")
            CompuMaster.Data.XlsReader.ReadDataTableFromXlsFile(TestFile, "test")
        End Sub
