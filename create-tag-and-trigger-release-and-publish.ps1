...
[string]$githubProjectUrl = 'https://github.com/CompuMasterGmbH/CompuMaster.Data/' #must contain trailing slash!
[string]$masterBranchName = "master" #ususally 'master' or 'main'
[string]$assemblyVersionSourceFilePath = ".\CompuMaster.Data\CompuMaster.Data.vbproj"
