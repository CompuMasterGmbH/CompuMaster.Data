                    ...
                    For counter As Integer = 0 To (MySearchResults.Count - 1)
                        Try
                            ...
                            If (Not IsNothing(MyUserEntry)) Then
                                ...
                                Dim _username As String = Convert.ToString(MyUserEntry.Properties.Item("sAMAccountName").Value, System.Globalization.CultureInfo.InvariantCulture)
                                Dim _firstname As String = Convert.ToString(MyUserEntry.Properties.Item("GivenName").Value, System.Globalization.CultureInfo.InvariantCulture)
                                Dim _lastname As String = Convert.ToString(MyUserEntry.Properties.Item("sn").Value, System.Globalization.CultureInfo.InvariantCulture)
                                Dim _displayname As String = Convert.ToString(MyUserEntry.Properties.Item("displayName").Value, System.Globalization.CultureInfo.InvariantCulture)
                                Dim _title As String = Convert.ToString(MyUserEntry.Properties.Item("title").Value, System.Globalization.CultureInfo.InvariantCulture)
                                Dim _email As String = Convert.ToString(MyUserEntry.Properties.Item("mail").Value, System.Globalization.CultureInfo.InvariantCulture)
                                Dim _phone As String = Convert.ToString(MyUserEntry.Properties.Item("telephoneNumber").Value, System.Globalization.CultureInfo.InvariantCulture)
                                Dim _mobilephone As String = Convert.ToString(MyUserEntry.Properties.Item("mobile").Value, System.Globalization.CultureInfo.InvariantCulture)
                                Dim _voipphone As String = Convert.ToString(MyUserEntry.Properties.Item("ipPhone").Value, System.Globalization.CultureInfo.InvariantCulture)
                                Dim _fax As String = Convert.ToString(MyUserEntry.Properties.Item("facsimileTelephoneNumber").Value, System.Globalization.CultureInfo.InvariantCulture)
                                Dim _street As String = Convert.ToString(MyUserEntry.Properties.Item("streetAddress").Value, System.Globalization.CultureInfo.InvariantCulture)
                                Dim _zip As String = Convert.ToString(MyUserEntry.Properties.Item("postalCode").Value, System.Globalization.CultureInfo.InvariantCulture)
                                Dim _city As String = Convert.ToString(MyUserEntry.Properties.Item("l").Value, System.Globalization.CultureInfo.InvariantCulture)
                                Dim _country As String = Convert.ToString(MyUserEntry.Properties.Item("co").Value, System.Globalization.CultureInfo.InvariantCulture)
                                Dim _company As String = Convert.ToString(MyUserEntry.Properties.Item("company").Value, System.Globalization.CultureInfo.InvariantCulture)
                                Dim _department As String = Convert.ToString(MyUserEntry.Properties.Item("department").Value, System.Globalization.CultureInfo.InvariantCulture)
                                Dim _initials As String = Convert.ToString(MyUserEntry.Properties.Item("initials").Value, System.Globalization.CultureInfo.InvariantCulture)
